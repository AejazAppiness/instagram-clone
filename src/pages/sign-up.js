        ...
        <div className="contianer flex mx-auto max-w-screen-md items-center h-screen">
            ...
            <div className="flex flex-col w-2/5"> 
                <div className="flex flex-col items-center bg-white p-4 border border-gray-primary mb-4">
                    ...
                    <form onSubmit={handleSignUp} method="POST">
                        <input 
                            ...
                            className="text-sm text-gray-base w-full mr-3 py-5 px-4 h-2 border border-gray-primary rounded mb-2" onChange={(e) => setUsername(e.target.value)} 
                            value={username}
                        />
                         <input 
                        ...
                        <input 
                            ...
                            className="text-sm text-gray-base w-full mr-3 py-5 px-4 h-2 border border-gray-primary rounded mb-2" onChange={(e) => setPassword(e.target.value)} 
                            value={password}
                        />
                ...
                <div className="flex justify-center items-center flex-col w-full bg-white p-4 border border-gray-primary">
                    ...
                    <Link to={ROUTES.LOGIN} className='font-bold text-blue-medium'>Sign up</Link></p>
                </div>
            </div>
        </div>
    )
